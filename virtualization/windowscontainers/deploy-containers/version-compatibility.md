...
- Reconstruire le conteneur en vous basant sur la version correcte de `mcr.microsoft.com/microsoft-windows-nanoserver` ou de `mcr.microsoft.com/windows/servercore`.
